    ...
    <section style={sectionStyle}>
      ...
      <div className="absolute top-1/2 left-[85%] transform -translate-x-2/3 -translate-y-1/2 text-start text-white">
        ...
        <div className="flex justify-start gap-[40px] mt-[20px]">
          <NavLink to='/chefio-global'><button className="bn5 rounded-lg bg-[rgba(0,0,0,0.17)] px-10 py-4 text-white cursor-pointer font-semibold hover:bg-slate-600 hover:scale-105 transition duration-300 ease-in-out relative">Sign up</button></NavLink>
